...
module.exports.handler = async (event, context) => {
    ...
    try{
        ...
        if( !sessionToken )
            ...
            let developer = await db.collection( "developers" ).findOne( q, {projection: p} )
            developer.profilePicture = presignURL( developer.profilePicture )
