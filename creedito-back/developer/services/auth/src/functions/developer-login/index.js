...
module.exports.handler = async (event, context) => {
    ...
    try{
        ...
        if( user ){
                ...
                if( event.body.otp ){
                    ...
                    if( verified ){
                        ...
                        if( !user.origins ){ // Primer login
                            ...
                            await db.collection( "developers" ).updateOne( q, s )
                        }else{
                        ...
                        await db.collection( "developers" ).updateOne( tmpQuery, setter )
            ...
            const { value } = await db.collection( "developers" ).findOneAndUpdate( tmpQuery, setter, options )
