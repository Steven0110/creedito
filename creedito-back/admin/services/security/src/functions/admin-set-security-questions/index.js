...
module.exports.handler = async (event, context) => {
    ...
    try{
        ...
        if( value ){
            ...
            // Envía notificación
            let html = `<div> <h2 style="text-align: center; color: #8396d3; font-family: Arial;">Notificación de operación<br/></h2> <p style="text-align: center;">Apreciable ${value.name}. Le informamos que las preguntas de seguridad han sido configuradas para su cuenta en éste momento.</p><p style="text-align: center;"> Si no reconoce ésta operación, por favor envíenos un correo a <strong>soporte@investus.mx</strong>. </p></div>`
            let params = {
                html: html,
