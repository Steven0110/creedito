...
module.exports.handler = async (event, context) => {
    ...
    try{
        ...
        let setter = {
            $set: {
                secretImage: event.body.secretImage
            }
        }
        ...
        if( value ){
            ...
            // Envía notificación
            let html = `<div> <h2 style="text-align: center; color: #8396d3; font-family: Arial;">Notificación de operación<br/></h2> <p style="text-align: center;">Apreciable ${value.name}. Le informamos que su imagen secreta ha sido configurada exitosamente en este momento.</p><p style="text-align: center;"> Si no reconoce ésta operación, por favor envíenos un correo a <strong>soporte@investus.mx</strong>. </p></div>`;
            let params = {
                html: html,
